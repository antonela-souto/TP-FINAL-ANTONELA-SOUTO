        ...
        <form action="noticias_editar_guardar.php" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control" id="fecha" name="fecha" placeholder="fecha(año-mes-día)" required
                    value="<?php print($resultado['fecha']); ?>">
            </div>
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="autor" name="autor" placeholder="autor" required
                    value="<?php print($resultado['autor']); ?>">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea rows="10" class="form-control" id="cuerpo" name="cuerpo"
                    required><?php print($resultado['cuerpo']); ?></textarea>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <select class="form-control" id="categoria" name="categoria" required>
                    <option value="Actualidad" <?php if ($resultado['categoria'] == "Actualidad")
                        print("selected"); ?>>
                        Actualidad</option>
                    <option value="Política" <?php if ($resultado['categoria'] == "Política")
                        print("selected"); ?>>Política
                    </option>
                    <option value="Economía" <?php if ($resultado['categoria'] == "Economia")
                        print("selected"); ?>>Economía
                    </option>
                    <option value="Salud" <?php if ($resultado['categoria'] == "Salud")
                        print("selected"); ?>>Salud</option>
                    <option value="Espectáculos" <?php if ($resultado['categoria'] == "Espectáculos")
                        print("selected"); ?>>
                        Espectáculos</option>
                    <option value="Moda" <?php if ($resultado['categoria'] == "Moda")
                        print("selected"); ?>>Moda</option>
                    <option value="Deportes" <?php if ($resultado['categoria'] == "Deportes")
                        print("selected"); ?>>Deportes
                    </option>
