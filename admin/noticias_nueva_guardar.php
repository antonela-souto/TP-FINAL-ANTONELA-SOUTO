<?php
    ...
    //metodo 1
    // <!-- código que guarda las noticias nuevas que se crearon -->
    ...
    $instruccion="insert into noticias (titulo,fecha,autor,copete,cuerpo,imagen,categoria,id_usuario) values ('$titulo','$fecha', '$autor','$copete','$cuerpo','$nombrefichero','$categoria','$id_usuario')";
   ...
   mysqli_stmt_execute($stmt);*/
    ...
    header("location:noticias.php?mensaje=Noticia Guardada");
?>  